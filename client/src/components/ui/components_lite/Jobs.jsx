...
import { Search, MapPin, Briefcase, Building2, DollarSign, Bookmark } from 'lucide-react';
                        ...
                        {jobs.map((job) => (
                            ...
                            >
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-gray-600 text-sm mb-4">{job.company || 'Company'}</p>
                                ...
                                <CardFooter className="p-6 pt-0">
                                    <Link to={isAuth ? `/description/${job._id}` : '/login'} className="w-full">
